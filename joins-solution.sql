...
3. SELECT "warehouse_id" (or *) FROM "warehouse_product"
WHERE "product_id" = 5;

4. SELECT * FROM "warehouse_product"
WHERE "product_id" = 6;

5. SELECT "customers"."first_name", "customers"."last_name", "customers"."id", COUNT(*) AS "orders"
FROM "customers"
